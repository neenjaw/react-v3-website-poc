import { IConceptMap } from '../concept-map/concept-map-types'
...
export const data: IConceptMap = {
  concepts: [
    ...
    },
    {
      ...
      web_url: 'http://lvh.me:3020/tracks/elixir/concepts/anonymous-functions',
    },
    {
      slug: 'closures',
      name: 'Closures',
    ...
    },
    {
      ...
      web_url: 'http://lvh.me:3020/tracks/elixir/concepts/tail-call-recursion',
    },
    {
      slug: 'enum',
      name: 'Enum',
    ...
    },
    {
      ...
      web_url: 'http://lvh.me:3020/tracks/elixir/concepts/regular-expressions',
    },
    {
      slug: 'list-comprehensions',
      name: 'List Comprehensions',
      web_url: 'http://lvh.me:3020/tracks/elixir/concepts/list-comprehensions',
    },
    {
      slug: 'protocols',
      name: 'Protocols',
  ...
  status: {
    ...
    atoms: 'completed',
    lists: 'unlocked',
    'string-literals': 'unlocked',
    'multiple-clause-functions': 'locked',
    guards: 'locked',
    'default-arguments': 'locked',
    ...
    nil: 'locked',
    if: 'locked',
    'module-attributes-as-constants': 'locked',
    maps: 'locked',
    recursion: 'locked',
    charlists: 'locked',
    case: 'locked',
    'access-behaviour': 'locked',
    bitstrings: 'locked',
    binaries: 'locked',
    'tail-call-recursion': 'locked',
    enum: 'locked',
    structs: 'locked',
    errors: 'locked',
    'try-rescue': 'locked',
    exceptions: 'locked',
    'keyword-lists': 'locked',
    io: 'unlocked',
    'try-rescue-else-after': 'locked',
    'dynamic-dispatch': 'locked',
    processes: 'locked',
    pids: 'locked',
    streams: 'locked',
    'pipe-operator': 'locked',
    ranges: 'locked',
    agent: 'locked',
    'regular-expressions': 'locked',
    'list-comprehensions': 'locked',
    protocols: 'locked',
  },
}
